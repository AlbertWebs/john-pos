                ...
                <div x-data="{ open: {{ request()->routeIs(['categories.*', 'brands.*', 'supplies.*', 'vehicle-makes.*', 'vehicle-models.*', 'customers.*', 'barcodes.*']) ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open || sidebarCollapsed" class="ml-4 space-y-1 border-l-2 border-blue-400/30 pl-3">
                        ...
                        <a href="{{ route('barcodes.index') }}" 
                           class="flex items-center {{ request()->routeIs('barcodes.*') ? 'bg-white/20 text-white' : 'text-blue-100 hover:bg-white/10' }} px-3 py-2 rounded-lg text-sm transition"
                           title="Barcodes"
                        >
                            <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('reports.*') || request()->routeIs('most-selling.*') ? 'true' : 'false' }} }">
                        ...
                        <div x-show="open || sidebarCollapsed" class="ml-4 space-y-1 border-l-2 border-blue-400/30 pl-3">
                            ...
                            <a href="{{ route('reports.sales') }}" 
                               class="flex items-center {{ request()->routeIs('reports.sales') ? 'bg-white/20 text-white' : 'text-blue-100 hover:bg-white/10' }} px-3 py-2 rounded-lg text-sm transition"
                               title="Sales Report"
                            >
                                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            >
                                ...
                                <span x-show="!sidebarCollapsed">Inventory Report</span>
                            </a>
                            <a href="{{ route('reports.top-selling') }}" 
                               class="flex items-center {{ request()->routeIs('reports.top-selling') ? 'bg-white/20 text-white' : 'text-blue-100 hover:bg-white/10' }} px-3 py-2 rounded-lg text-sm transition"
                               title="Top Selling Parts"
                            >
                                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                </svg>
                                <span x-show="!sidebarCollapsed">Top Selling</span>
                            </a>
                            ...
                            <a href="{{ route('reports.stock-audit') }}" 
                               class="flex items-center {{ request()->routeIs('reports.stock-audit') ? 'bg-white/20 text-white' : 'text-blue-100 hover:bg-white/10' }} px-3 py-2 rounded-lg text-sm transition"
                               title="Stock Audit"
                            >
                                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                                </svg>
                                <span x-show="!sidebarCollapsed">Stock Audit</span>
                            </a>
                            <a href="{{ route('reports.sold-vs-cost') }}" 
                               class="flex items-center {{ request()->routeIs('reports.sold-vs-cost') ? 'bg-white/20 text-white' : 'text-blue-100 hover:bg-white/10' }} px-3 py-2 rounded-lg text-sm transition"
                               title="Sold price vs cost"
                            >
                                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
