...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Edit Vehicle Make</h1>
        <p class="text-gray-600 mt-1">{{ $vehicleMake->make_name }}</p>
    </div>

    <div class="bg-white rounded-lg shadow-md p-8">
        <form method="POST" action="{{ route('vehicle-makes.update', $vehicleMake) }}">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="make_name" 
                        id="make_name"
                        value="{{ old('make_name', $vehicleMake->make_name) }}"
                        required
