...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-8 mt-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-2">Your login PIN</h2>
        <p class="text-gray-600 text-sm mb-4">Change the 4-digit PIN you use to sign in. You will be signed out and must log in again with your new PIN.</p>
        <a href="{{ route('account.pin.edit') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-semibold transition">
