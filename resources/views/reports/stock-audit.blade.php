    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="GET" action="{{ route('reports.stock-audit') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('reports.stock-audit', array_merge(request()->query(), ['export' => 'excel'])) }}" class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg font-semibold inline-flex items-center gap-2">
